...
pub fn fft(comptime C: type, N: usize, w1: [*]C, w3: [*]C, out: [*]C, in: [*]C, sr_input_lut: [*]usize, sr_sched_off: [*]usize, sr_sched_cnt: [*]usize) void {
    ...
    sr_dit_bi_G_L(C, w1, w3, out, in, N, log2_N, sr_input_lut, sr_sched_off, sr_sched_cnt);
}

pub fn sr_dit_bi_G_L(comptime C: type, w1: [*]C, w3: [*]C, out: [*]C, in: [*]C, N: usize, log2_N: usize, sr_input_lut: [*]usize, sr_sched_off: [*]usize, sr_sched_cnt: [*]usize) void {
